...
function commandInfo(toolbox, commandRoot) {
    return toolbox.runtime.commands.reduce(function (commands, command) {
        if (!command.hidden && (!commandRoot || utils_1.equals(command.commandPath.slice(0, commandRoot.length), commandRoot))) {
            ...
            commands.push([
                ...
                utils_1.replace('$BRAND', toolbox.runtime.brand, command.description || '-'),
            ]);
        }
        return commands;
    }, []);
