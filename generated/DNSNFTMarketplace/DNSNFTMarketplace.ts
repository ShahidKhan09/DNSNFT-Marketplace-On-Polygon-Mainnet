...
export class DNSNFTMarketplace__addressForBalanceResult {
  value0: BigInt;
  value1: BigInt;
...
export class DNSNFTMarketplace__tokenIdForAllBidsResult {
  value0: Address;
  value1: BigInt;
...
export class DNSNFTMarketplace__tokenIdForCurrentBidResult {
  value0: Address;
  value1: BigInt;
...
export class DNSNFTMarketplace__tokenIdForWordInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class DNSNFTMarketplace extends ethereum.SmartContract {
  static bind(address: Address): DNSNFTMarketplace {
    return new DNSNFTMarketplace("DNSNFTMarketplace", address);
  }

  addressForBalance(
    param0: Address,
    param1: BigInt
  ): DNSNFTMarketplace__addressForBalanceResult {
    ...
    return new DNSNFTMarketplace__addressForBalanceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_addressForBalance(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<DNSNFTMarketplace__addressForBalanceResult> {
    ...
    return ethereum.CallResult.fromValue(
      new DNSNFTMarketplace__addressForBalanceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  contracter(): Address {
    let result = super.call("contracter", "contracter():(address)", []);

    return result[0].toAddress();
  }

  try_contracter(): ethereum.CallResult<Address> {
    let result = super.tryCall("contracter", "contracter():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  tokenIdForAllBids(
    param0: BigInt,
    param1: BigInt
  ): DNSNFTMarketplace__tokenIdForAllBidsResult {
    let result = super.call(
      "tokenIdForAllBids",
    ...
    return new DNSNFTMarketplace__tokenIdForAllBidsResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_tokenIdForAllBids(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<DNSNFTMarketplace__tokenIdForAllBidsResult> {
    let result = super.tryCall(
      "tokenIdForAllBids",
      "tokenIdForAllBids(uint256,uint256):(address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DNSNFTMarketplace__tokenIdForAllBidsResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  tokenIdForCurrentBid(
    param0: BigInt
  ): DNSNFTMarketplace__tokenIdForCurrentBidResult {
    let result = super.call(
      "tokenIdForCurrentBid",
    ...
    return new DNSNFTMarketplace__tokenIdForCurrentBidResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_tokenIdForCurrentBid(
    param0: BigInt
  ): ethereum.CallResult<DNSNFTMarketplace__tokenIdForCurrentBidResult> {
    let result = super.tryCall(
      "tokenIdForCurrentBid",
      "tokenIdForCurrentBid(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DNSNFTMarketplace__tokenIdForCurrentBidResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  tokenIdForWordInfo(
    param0: BigInt
  ): DNSNFTMarketplace__tokenIdForWordInfoResult {
    let result = super.call(
      "tokenIdForWordInfo",
    ...
    return new DNSNFTMarketplace__tokenIdForWordInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_tokenIdForWordInfo(
    param0: BigInt
  ): ethereum.CallResult<DNSNFTMarketplace__tokenIdForWordInfoResult> {
    let result = super.tryCall(
      "tokenIdForWordInfo",
      "tokenIdForWordInfo(uint256):(address,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DNSNFTMarketplace__tokenIdForWordInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
...
export class SetContracterAddressCall extends ethereum.Call {
  get inputs(): SetContracterAddressCall__Inputs {
    return new SetContracterAddressCall__Inputs(this);
  }

  get outputs(): SetContracterAddressCall__Outputs {
    return new SetContracterAddressCall__Outputs(this);
  }
}

export class SetContracterAddressCall__Inputs {
  _call: SetContracterAddressCall;

  constructor(call: SetContracterAddressCall) {
    this._call = call;
  }

  get _contracter(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetContracterAddressCall__Outputs {
  _call: SetContracterAddressCall;
...
export class TestChangeGlobalExpiryTimeCall extends ethereum.Call {
  get inputs(): TestChangeGlobalExpiryTimeCall__Inputs {
    return new TestChangeGlobalExpiryTimeCall__Inputs(this);
  }

  get outputs(): TestChangeGlobalExpiryTimeCall__Outputs {
    return new TestChangeGlobalExpiryTimeCall__Outputs(this);
  }
}

export class TestChangeGlobalExpiryTimeCall__Inputs {
  _call: TestChangeGlobalExpiryTimeCall;

  constructor(call: TestChangeGlobalExpiryTimeCall) {
    this._call = call;
  }
...
export class TestChangeGlobalExpiryTimeCall__Outputs {
  _call: TestChangeGlobalExpiryTimeCall;
